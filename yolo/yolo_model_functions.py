...
def create_data_directories(model_type):
    train_img_path = "./yolo/" + model_type + "/images/train/"
    val_img_path = "./yolo/" + model_type + "/images/val/"
    test_img_path = "./yolo/" + model_type + "/images/test/"
    train_lbl_path = "./yolo/" + model_type + "/labels/train/"
    val_lbl_path = "./yolo/" + model_type + "/labels/val/"
    test_lbl_path = "./yolo/" + model_type + "/labels/test/"
