#
# Adapted from microsoft/CameraTraps script: download_lila_subset.py
#
...
datasets_of_interest = ['Orinoquia Camera Traps', 'GeoLifeCLEF 2020', 'Caltech Camera Traps', 'SWG Camera Traps']

# List species of interest to add to training dataset
species_of_interest = ['Pig', 'Peccary', 'Coati', 'Puma', 'Jaguar', 'Jaguarundi', 'Margay', 'Ocelot', 'Mountain_Lion',
                       'Bobcat']
